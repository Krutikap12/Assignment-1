...
namespace Delegate1
{
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            IsEligibleforScholarship isEligibleStudent = new IsEligibleforScholarship(ScholarshipEligibility);
            var eligible = Student.GetEligibleStudents(lstStudents, isEligibleStudent);
